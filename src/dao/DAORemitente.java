...
public class DAORemitente {
	...
	public ArrayList<Remitente> darRemitentes() throws SQLException, Exception 
	{
		...
		String sql = "SELECT * FROM ISIS2304A091620.REMITENTES";
		...
		while (rs.next()) 
		{
			...
			Remitente r= new Remitente(an.getId(),an.getTipoId(), an.getNombre());
			remitentes.add(r);
		}
		return remitentes;
	}
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public Remitente buscarRemitentePorId(int id) throws SQLException, Exception
	{
		Remitente anca = null;

		String sql = "SELECT * FROM ISIS2304A091620.REMITENTES WHERE ID ='" + id + "'";
		...
		while (rs.next()) 
		{
			DAOClientes res = new DAOClientes();
			Cliente an = res.buscarClientePorId(rs.getInt("ID"));
			anca =  new Remitente(an.getId(),an.getTipoId(), an.getNombre());
		}
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void addRemitente(Remitente anc) throws SQLException, Exception 
	{
		DAOClientes aero = new DAOClientes();
		aero.addCliente(anc);
		String sql2 = "INSERT ISIS2304A091620.REMITENTES VALUES ('";
		sql2 += anc.getId() + "')";
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void updateRemitente(Remitente anca) throws SQLException, Exception 
	{
		DAOClientes aero = new DAOClientes();
		String sql = "UPDATE ISIS2304A091620.REMITENTES SET ";
		sql += "ID '" + anca.getId() + "',";
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void deleteRemitente(Remitente anca) throws SQLException, Exception 
	{
		DAOClientes aero = new DAOClientes();
		String sql = "DELETE FROM ISIS2304A091620.REMITENTES";
		sql += " WHERE ID = " + anca.getId();
