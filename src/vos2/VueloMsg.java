...
public class VueloMsg 
{
	...
	public VueloMsg(@JsonProperty(value="id") String id,@JsonProperty(value="duracion") Double duracion,@JsonProperty(value="distancia") Double distancia,@JsonProperty(value="frecuencia") int frecuencia,@JsonProperty(value="tipo")
